...
namespace server.Controllers
{
    ...
    public partial class UserController : ControllerBase {
        ...
        private string PostFile(int? userId, [FromForm]IFormFile objFile){
            ...
            try {
                if (!System.IO.Directory.Exists(_environment.WebRootPath +"\\Uploads\\Uploads/UserProfileImages\\")) {
                    System.IO.Directory.CreateDirectory(_environment.WebRootPath +"\\Uploads\\Uploads/UserProfileImages\\");
                }
              
                Filepath = _environment.WebRootPath +"\\Uploads\\Uploads/UserProfileImages\\" + objFile.FileName;
