    ...
    static demoServices: IService[] = [
        {
            ...
            description: 'You are always welcome to the Spa salon to put the problems of your day aside for a moment and enjoy our excellent care!',
            duration: 30,
            price: 25
        },
        {
        ...
        },
        {
            ...
            description: 'We specialize in massage services and you can book for them at our salons, hotel room, home or even at your office!',
            duration: 60,
            price: 40
        },
    ];
